...
long long main(void)
{
    ...
    local_20 = 0;
    for (local_28 = 0;
         (iVar2 = counter + 1, bVar1 = counter < 0x32, counter = iVar2, bVar1 && (__VERIFIER_assert((local_20 * 4 - local_18 * local_18 * local_18 * local_18) + local_18 * local_18 * local_18 * -2 == local_18 * local_18), local_28 < local_2a)); local_28 = local_28 + 1)
    {
        local_18 = local_18 + 1;
