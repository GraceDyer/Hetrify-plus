...
long long main(void)
{
    ...
    local_20 = 0;
    for (local_18 = 0;
         (iVar2 = counter + 1, bVar1 = counter < 2, counter = iVar2, bVar1 && (__VERIFIER_assert(local_28 == ((local_18 * local_2c - local_20 * local_30) * 2 - (long)local_30) + (long)local_2c * 2), local_18 <= local_30)); local_18 = local_18 + 1)
    {
        if (local_28 < 0)
        {
            lVar3 = (long)local_2c;
