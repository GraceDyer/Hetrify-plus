...
L_101a8: {//lw_main
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[13] = *(int32_t*)(&(((uint8_t*)stack0)[24]));
    }
L_101ac: {//mulw_main
    uint64_t rs1 = c->gp_regs[13];
    uint64_t rs2 = c->gp_regs[15];
...
L_10218: {//lw_main
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[13] = *(int32_t*)(&(((uint8_t*)stack0)[20]));
    }
L_1021c: {//mulw_main
    uint64_t rs1 = c->gp_regs[13];
    uint64_t rs2 = c->gp_regs[15];
...
L_1024c: {//lw_main
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[12] = *(int32_t*)(&(((uint8_t*)stack0)[24]));
    }
L_10250: {//mulw_main
    uint64_t rs1 = c->gp_regs[12];
    uint64_t rs2 = c->gp_regs[15];
...
L_10304: {//lw_main
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[13] = *(int32_t*)(&(((uint8_t*)stack0)[28]));
    }
L_10308: {//mulw_main
    uint64_t rs1 = c->gp_regs[13];
    uint64_t rs2 = c->gp_regs[15];
...
L_103a4: {//lw_main
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[12] = *(int32_t*)(&(((uint8_t*)stack0)[20]));
    }
L_103a8: {//mulw_main
    uint64_t rs1 = c->gp_regs[12];
    uint64_t rs2 = c->gp_regs[15];
