...
L_1007c: {//sraiw_main
    uint64_t rs1 = c->gp_regs[15];
    c->gp_regs[14] = (int64_t)((int32_t)rs1 >> 31);
    }
L_10080: {//srliw_main
    uint64_t rs1 = c->gp_regs[14];
    c->gp_regs[14] = (int64_t)(int32_t)((uint32_t)rs1 >> 27);
    }
L_10084: {//addw_main
    uint64_t rs1 = c->gp_regs[14];
    uint64_t rs2 = c->gp_regs[15];
...
L_10088: {//sraiw_main
    uint64_t rs1 = c->gp_regs[15];
    c->gp_regs[15] = (int64_t)((int32_t)rs1 >> 5);
    }
L_1008c: {//addiw_main
    uint64_t rs1 = c->gp_regs[15];
...
L_1011c: {//srliw_main
    uint64_t rs1 = c->gp_regs[14];
    c->gp_regs[14] = (int64_t)(int32_t)((uint32_t)rs1 >> 30);
    }
L_10120: {//addw_main
    uint64_t rs1 = c->gp_regs[14];
    uint64_t rs2 = c->gp_regs[15];
...
L_1015c: {//srliw_main
    uint64_t rs1 = c->gp_regs[14];
    c->gp_regs[14] = (int64_t)(int32_t)((uint32_t)rs1 >> 29);
    }
L_10160: {//addw_main
    uint64_t rs1 = c->gp_regs[14];
    uint64_t rs2 = c->gp_regs[15];
