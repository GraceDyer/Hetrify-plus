...
L_100fc: {//lw_main
    uint64_t rs1 = c->gp_regs[8];
    int32_t rd = *(int32_t *)(rs1 + (int64_t)-120LL);
    c->gp_regs[15] = rd;
    }
L_10100: {//sw_main
    uint64_t rs1 = c->gp_regs[8];
...
L_10104: {//lw_main
    uint64_t rs1 = c->gp_regs[8];
    int32_t rd = *(int32_t *)(rs1 + (int64_t)-116LL);
    c->gp_regs[15] = rd;
    }
L_10108: {//sw_main
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *(uint32_t *)(rs1 + (int64_t)-120LL) = (uint32_t)rs2;
    }
L_1010c: {//lw_main
    uint64_t rs1 = c->gp_regs[8];
...
L_10110: {//sw_main
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *(uint32_t *)(rs1 + (int64_t)-116LL) = (uint32_t)rs2;
    }
L_10114: {//addi_main
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = rs1 + (int64_t)-120LL;
