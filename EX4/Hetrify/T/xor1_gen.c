...
L_100ac: {//sd_main
    uint64_t rs1 = c->gp_regs[2];
    uint64_t rs2 = c->gp_regs[8];
    *(uint64_t *)(rs1 + (int64_t)432LL) = (uint64_t)rs2;
    }
L_100b0: {//addi_main
    uint64_t rs1 = c->gp_regs[2];
...
L_100ec: {//lw_main
    uint64_t rs1 = c->gp_regs[8];
    int32_t rd = *(int32_t *)(rs1 + (int64_t)-440LL);
    c->gp_regs[15] = rd;
    }
L_100f0: {//sw_main
    uint64_t rs1 = c->gp_regs[8];
...
L_100f8: {//sw_main
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *(uint32_t *)(rs1 + (int64_t)-440LL) = (uint32_t)rs2;
    }
L_100fc: {//lw_main
    uint64_t rs1 = c->gp_regs[8];
...
L_101d0: {//ld_main
    uint64_t rs1 = c->gp_regs[2];
    int64_t rd = *(int64_t *)(rs1 + (int64_t)432LL);
    c->gp_regs[8] = rd;
    }
L_101d4: {//addi_main
    uint64_t rs1 = c->gp_regs[2];
