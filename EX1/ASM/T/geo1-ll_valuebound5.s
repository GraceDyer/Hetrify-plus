...
.Ltext0:
	...
	.file 0 "/home/grace/gitlib/rvemu/data/T_cov" "./geo1-ll_valuebound5.c"
	.globl	assert_ret1
	.section	.sdata,"aw"
	.align	2
...
.LFB2:
	...
	li	a5,5
	bgt	a4,a5,.L8
	.loc 1 23 21 discriminator 2
	lw	a5,-48(s0)
	sext.w	a5,a5
	ble	a5,zero,.L8
	.loc 1 23 31 discriminator 3
	lw	a5,-48(s0)
	sext.w	a5,a5
	blt	a5,zero,.L8
	.loc 1 23 39 discriminator 4
	lw	a5,-48(s0)
	sext.w	a4,a5
	li	a5,5
	bgt	a4,a5,.L8
	.loc 1 23 47 discriminator 5
	lw	a5,-44(s0)
	sext.w	a5,a5
	ble	a5,zero,.L8
	.loc 1 25 7
