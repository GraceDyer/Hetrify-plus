...
.Ltext0:
	...
	.file 0 "/home/grace/gitlib/rvemu/data/T_cov" "./lcm2_valuebound10.c"
	.globl	assert_ret1
	.section	.sdata,"aw"
	.align	2
...
.LFB2:
	...
	li	a5,10
	bgtu	a4,a5,.L8
	.loc 1 22 36 discriminator 1
	lw	a5,-40(s0)
	sext.w	a4,a5
	li	a5,65536
	bgeu	a4,a5,.L8
	.loc 1 22 44 discriminator 2
	lw	a5,-40(s0)
	sext.w	a4,a5
	li	a5,10
	bgtu	a4,a5,.L8
	.loc 1 22 53 discriminator 3
	lw	a5,-36(s0)
	sext.w	a5,a5
	beq	a5,zero,.L8
	.loc 1 22 63 discriminator 4
	lw	a5,-40(s0)
	sext.w	a5,a5
	beq	a5,zero,.L8
	.loc 1 22 73 discriminator 5
	lw	a5,-36(s0)
	sext.w	a4,a5
	li	a5,65536
	bgeu	a4,a5,.L8
