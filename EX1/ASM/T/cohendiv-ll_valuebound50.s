	.file	"cohendiv-ll_valuebound50.c"
	.option nopic
...
.Ltext0:
	...
	.file 0 "/home/grace/gitlib/rvemu/data/T_cov" "./cohendiv-ll_valuebound50.c"
	.globl	assert_ret1
	.section	.sdata,"aw"
	.align	2
...
reach_error:
.LFB0:
	.file 1 "./cohendiv-ll_valuebound50.c"
	.loc 1 4 20
	.cfi_startproc
	addi	sp,sp,-16
...
.LFB2:
	...
	li	a5,50
	bgt	a4,a5,.L8
	.loc 1 24 22 discriminator 2
	lw	a5,-56(s0)
	sext.w	a5,a5
	ble	a5,zero,.L8
	.loc 1 24 32 discriminator 3
	lw	a5,-56(s0)
	sext.w	a5,a5
	blt	a5,zero,.L8
	.loc 1 24 40 discriminator 4
	lw	a5,-56(s0)
	sext.w	a4,a5
	li	a5,50
	bgt	a4,a5,.L8
...
.LASF0:
	.string	"./cohendiv-ll_valuebound50.c"
	.ident	"GCC: () 13.2.0"
