...
.Ltext0:
	...
	.file 0 "/home/grace/gitlib/rvemu/data/F_cov" "./id_trans.c"
	.globl	assert_ret1
	.section	.sdata,"aw"
	.align	2
...
.LFB2:
	...
	sext.w	a5,a5
	beq	a5,a4,.L8
	.loc 1 15 45 discriminator 1
	li	a5,0
	.loc 1 15 45 is_stmt 0
	j	.L9
.L8:
...
.L10:
	...
	sraiw	a5,a5,3
	sext.w	a4,a5
	.loc 1 16 37 discriminator 1
	lw	a5,-20(s0)
	sext.w	a5,a5
	bge	a5,a4,.L11
	.loc 1 16 37 is_stmt 0 discriminator 3
	lw	a5,-20(s0)
	mv	a4,a5
	lw	a5,-32(s0)
	sext.w	a4,a4
