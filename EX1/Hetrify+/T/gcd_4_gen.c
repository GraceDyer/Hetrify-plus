...
L_1002c: {//sd___VERIFIER_assert
    uint64_t rs1 = c->gp_regs[2];
    uint64_t rs2 = c->gp_regs[8];
    *( uint64_t*)(&(((uint8_t*)stack2)[16]))=(uint64_t)rs2;
    }
...
L_10058: {//ld___VERIFIER_assert
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[1] = *(int64_t*)(&(((uint8_t*)stack2)[24]));
    }
L_1005c: {//ld___VERIFIER_assert
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[8] = *(int64_t*)(&(((uint8_t*)stack2)[16]));
    }
...
/*******************    Function: gcd_test   *********************/
void gcd_test(cpu_t *c) { 
L_10068: {//addi_gcd_test
...
L_100f8: {//addi_gcd_test
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[2] = rs1 + (int64_t)32LL;
    }
L_100fc: {//jalr_gcd_test
    uint64_t rs1 = c->gp_regs[1];
    }
}
...
L_10120: {//ld_main
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[11] = *(int64_t*)(&(((uint8_t*)stack0)[16]));
    }
L_10124: {//ld_main
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[10] = *(int64_t*)(&(((uint8_t*)stack0)[24]));
    }
L_10128: {//jal_main
    c->gp_regs[1] = 65836LL;
    gcd_test(c);
