...
int getClientKeyringSize(int arg0){
    ...
    cpu_t *c=&cpu;
    uint64_t stack6[6];
    c->gp_regs[sp]=(uint64_t)&stack6[6];
    c->gp_regs[a0]=arg0;
L_10000: {//addi_getClientKeyringSize
    c->gp_regs[2] = &stack6[6];
...
L_10004: {//sd_getClientKeyringSize
    ...
    *( uint64_t*)(&(((uint8_t*)stack6)[40]))=(uint64_t)rs2;
    }
...
L_10010: {//sw_getClientKeyringSize
    ...
    *( uint32_t*)(&(((uint8_t*)stack6)[12]))=(uint32_t)rs2;
    }
L_10014: {//lw_getClientKeyringSize
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack6)[12]));
    }
...
L_1002c: {//sw_getClientKeyringSize
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint32_t*)(&(((uint8_t*)stack6)[28]))=(uint32_t)rs2;
    }
L_10030: {//lw_getClientKeyringSize
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack6)[28]));
    }
...
L_1008c: {//ld_getClientKeyringSize
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[8] = *(int64_t*)(&(((uint8_t*)stack6)[40]));
    }
...
void setClientKeyringSize(int arg0, int arg1){
    ...
    cpu_t *c=&cpu;
    uint64_t stack5[4];
    c->gp_regs[sp]=(uint64_t)&stack5[4];
    c->gp_regs[a0]=arg0;
    c->gp_regs[a1]=arg1;
L_10098: {//addi_setClientKeyringSize
    c->gp_regs[2] = &stack5[4];
    uint64_t rs1 = c->gp_regs[2];
...
L_1009c: {//sd_setClientKeyringSize
    uint64_t rs1 = c->gp_regs[2];
    uint64_t rs2 = c->gp_regs[8];
    *( uint64_t*)(&(((uint8_t*)stack5)[24]))=(uint64_t)rs2;
    }
...
L_100ac: {//sw_setClientKeyringSize
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint32_t*)(&(((uint8_t*)stack5)[12]))=(uint32_t)rs2;
    }
...
L_100b4: {//sw_setClientKeyringSize
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint32_t*)(&(((uint8_t*)stack5)[8]))=(uint32_t)rs2;
    }
L_100b8: {//lw_setClientKeyringSize
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack5)[12]));
    }
...
L_100cc: {//lw_setClientKeyringSize
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[14] = *(int32_t*)(&(((uint8_t*)stack5)[8]));
    }
...
L_1011c: {//ld_setClientKeyringSize
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[8] = *(int64_t*)(&(((uint8_t*)stack5)[24]));
    }
...
L_10130: {//sd_createClientKeyringEntry
    uint64_t rs1 = c->gp_regs[2];
    uint64_t rs2 = c->gp_regs[8];
    *( uint64_t*)(&(((uint8_t*)stack4)[32]))=(uint64_t)rs2;
    }
...
L_10140: {//lw_createClientKeyringEntry
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack4)[12]));
    }
...
L_10154: {//lw_createClientKeyringEntry
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack4)[28]));
    }
L_10158: {//sw_createClientKeyringEntry
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint32_t*)(&(((uint8_t*)stack4)[24]))=(uint32_t)rs2;
    }
L_1015c: {//lw_createClientKeyringEntry
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack4)[24]));
    }
...
L_10174: {//sw_createClientKeyringEntry
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint32_t*)(&(((uint8_t*)stack4)[16]))=(uint32_t)rs2;
    }
L_10178: {//lw_createClientKeyringEntry
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[14] = *(int32_t*)(&(((uint8_t*)stack4)[16]));
    }
...
L_10194: {//sw_createClientKeyringEntry
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint32_t*)(&(((uint8_t*)stack4)[20]))=(uint32_t)rs2;
    }
L_10198: {//lw_createClientKeyringEntry
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack4)[20]));
    }
...
L_101b0: {//ld_createClientKeyringEntry
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[1] = *(int64_t*)(&(((uint8_t*)stack4)[40]));
    }
L_101b4: {//ld_createClientKeyringEntry
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[8] = *(int64_t*)(&(((uint8_t*)stack4)[32]));
    }
...
int getEmailId(int arg0){
    ...
    cpu_t *c=&cpu;
    uint64_t stack3[6];
    c->gp_regs[sp]=(uint64_t)&stack3[6];
    c->gp_regs[a0]=arg0;
L_101c0: {//addi_getEmailId
    c->gp_regs[2] = &stack3[6];
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[2] = rs1 + (int64_t)-48LL;
    }
L_101c4: {//sd_getEmailId
    uint64_t rs1 = c->gp_regs[2];
    uint64_t rs2 = c->gp_regs[8];
    *( uint64_t*)(&(((uint8_t*)stack3)[40]))=(uint64_t)rs2;
    }
...
L_101d4: {//lw_getEmailId
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack3)[12]));
    }
...
L_101ec: {//sw_getEmailId
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint32_t*)(&(((uint8_t*)stack3)[28]))=(uint32_t)rs2;
    }
L_101f0: {//lw_getEmailId
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack3)[28]));
    }
...
L_10228: {//ld_getEmailId
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[8] = *(int64_t*)(&(((uint8_t*)stack3)[40]));
    }
...
void setEmailId(int arg0, int arg1){
    ...
    cpu_t *c=&cpu;
    uint64_t stack2[4];
    c->gp_regs[sp]=(uint64_t)&stack2[4];
    c->gp_regs[a0]=arg0;
    c->gp_regs[a1]=arg1;
L_10234: {//addi_setEmailId
    c->gp_regs[2] = &stack2[4];
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[2] = rs1 + (int64_t)-32LL;
    }
...
L_10250: {//sw_setEmailId
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint32_t*)(&(((uint8_t*)stack2)[8]))=(uint32_t)rs2;
    }
L_10254: {//lw_setEmailId
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack2)[12]));
    }
...
L_10268: {//lw_setEmailId
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[14] = *(int32_t*)(&(((uint8_t*)stack2)[8]));
    }
...
L_10298: {//ld_setEmailId
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[8] = *(int64_t*)(&(((uint8_t*)stack2)[24]));
    }
