...
L_10014: {//sb_node1
    ...
    *( uint8_t*)(&(((uint8_t*)stack5)[15]))=(uint8_t)rs2;
    }
L_10018: {//lui_node1
    c->gp_regs[15] = 65536LL;
    }
...
L_10060: {//lbu_node1
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(uint8_t*)(&(((uint8_t*)stack5)[15]));
    }
L_10064: {//andi_node1
    uint64_t rs1 = c->gp_regs[15];
...
L_10084: {//lbu_node1
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[14] = *(uint8_t*)(&(((uint8_t*)stack5)[15]));
    }
L_10088: {//sb_node1
    uint64_t rs1 = c->gp_regs[15];
    uint64_t rs2 = c->gp_regs[14];
...
L_10120: {//sd_node2
    uint64_t rs1 = c->gp_regs[2];
    uint64_t rs2 = c->gp_regs[8];
    *( uint64_t*)(&(((uint8_t*)stack4)[24]))=(uint64_t)rs2;
    }
L_10124: {//addi_node2
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[8] = rs1 + (int64_t)32LL;
...
L_10130: {//sb_node2
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint8_t*)(&(((uint8_t*)stack4)[15]))=(uint8_t)rs2;
    }
L_10134: {//lui_node2
    c->gp_regs[15] = 65536LL;
    }
...
L_10164: {//lbu_node2
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(uint8_t*)(&(((uint8_t*)stack4)[15]));
    }
L_10168: {//andi_node2
    uint64_t rs1 = c->gp_regs[15];
    c->gp_regs[15] = rs1 & 255ULL;
...
L_10188: {//lbu_node2
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[14] = *(uint8_t*)(&(((uint8_t*)stack4)[15]));
    }
L_1018c: {//sb_node2
    uint64_t rs1 = c->gp_regs[15];
    uint64_t rs2 = c->gp_regs[14];
...
L_10214: {//ld_node2
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[8] = *(int64_t*)(&(((uint8_t*)stack4)[24]));
    }
L_10218: {//addi_node2
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[2] = rs1 + (int64_t)32LL;
...
L_10234: {//sb_node3
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint8_t*)(&(((uint8_t*)stack3)[15]))=(uint8_t)rs2;
    }
L_10238: {//lui_node3
    c->gp_regs[15] = 65536LL;
    }
...
L_10268: {//lbu_node3
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(uint8_t*)(&(((uint8_t*)stack3)[15]));
    }
L_1026c: {//andi_node3
    uint64_t rs1 = c->gp_regs[15];
    c->gp_regs[15] = rs1 & 255ULL;
...
L_1028c: {//lbu_node3
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[14] = *(uint8_t*)(&(((uint8_t*)stack3)[15]));
    }
L_10290: {//sb_node3
    uint64_t rs1 = c->gp_regs[15];
    uint64_t rs2 = c->gp_regs[14];
...
L_10318: {//ld_node3
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[8] = *(int64_t*)(&(((uint8_t*)stack3)[24]));
    }
L_1031c: {//addi_node3
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[2] = rs1 + (int64_t)32LL;
...
L_10338: {//sb_node4
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint8_t*)(&(((uint8_t*)stack2)[15]))=(uint8_t)rs2;
    }
L_1033c: {//lui_node4
    c->gp_regs[15] = 65536LL;
    }
...
L_1036c: {//lbu_node4
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(uint8_t*)(&(((uint8_t*)stack2)[15]));
    }
L_10370: {//andi_node4
    uint64_t rs1 = c->gp_regs[15];
    c->gp_regs[15] = rs1 & 255ULL;
...
L_10390: {//lbu_node4
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[14] = *(uint8_t*)(&(((uint8_t*)stack2)[15]));
    }
L_10394: {//sb_node4
    uint64_t rs1 = c->gp_regs[15];
    uint64_t rs2 = c->gp_regs[14];
...
L_1043c: {//sb_node5
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint8_t*)(&(((uint8_t*)stack1)[15]))=(uint8_t)rs2;
    }
L_10440: {//lui_node5
    c->gp_regs[15] = 65536LL;
    }
...
L_10470: {//lbu_node5
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(uint8_t*)(&(((uint8_t*)stack1)[15]));
    }
L_10474: {//andi_node5
    uint64_t rs1 = c->gp_regs[15];
    c->gp_regs[15] = rs1 & 255ULL;
...
L_10494: {//lbu_node5
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[14] = *(uint8_t*)(&(((uint8_t*)stack1)[15]));
    }
L_10498: {//sb_node5
    uint64_t rs1 = c->gp_regs[15];
    uint64_t rs2 = c->gp_regs[14];
...
L_10574: {//lbu_node6
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(uint8_t*)(&(((uint8_t*)stack0)[15]));
    }
L_10578: {//andi_node6
    uint64_t rs1 = c->gp_regs[15];
    c->gp_regs[15] = rs1 & 255ULL;
