...
extern void updata_p(char *p_old,char *p_new,char nomsg);
int main(void) 
{ 
  int c1 ;
  int i2 ;
  ...
  while (i2 < 6) {
    ...
    node2();
    node3();
    updata_p(&p12_old,&p12_new,nomsg);

    updata_p(&p13_old,&p13_new,nomsg);

    updata_p(&p21_old,&p21_new,nomsg);

    updata_p(&p23_old,&p23_new,nomsg);

    updata_p(&p31_old,&p31_new,nomsg);

    updata_p(&p32_old,&p32_new,nomsg);
    c1 = check();
    assert(c1);
    i2 ++;
    }
