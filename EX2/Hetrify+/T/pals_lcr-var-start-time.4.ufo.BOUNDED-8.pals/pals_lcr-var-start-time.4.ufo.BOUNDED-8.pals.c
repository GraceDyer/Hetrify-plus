...
_Bool mode4  ;
_Bool alive4  ;
extern void do_alive(_Bool alive,char *p_new, char* send, char *id, char nomsg,_Bool *mode);
void node1(void) 
{ 
  msg_t m1 ;
...
{ 
  ...
  if (mode2) {
    ...
    do_alive(alive2,&p2_new,&send2,&id2,nomsg,&mode2);
  }
  return;
}
}
...
{ 
  ...
  if (mode3) {
    ...
    do_alive(alive3,&p3_new,&send3,&id3,nomsg,&mode3);
  }
  return;
}
}
...
{ 
  ...
  if (mode4) {
    ...
    do_alive(alive4,&p4_new,&send4,&id4,nomsg,&mode4);
  }
  return;
}
}
