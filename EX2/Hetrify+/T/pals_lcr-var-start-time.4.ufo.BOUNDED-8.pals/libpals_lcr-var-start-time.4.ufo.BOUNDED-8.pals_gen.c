...
L_10020: {//sb_do_alive
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint8_t*)(&(((uint8_t*)stack0)[47]))=(uint8_t)rs2;
    }
...
L_10028: {//sb_do_alive
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint8_t*)(&(((uint8_t*)stack0)[46]))=(uint8_t)rs2;
    }
L_1002c: {//lbu_do_alive
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(uint8_t*)(&(((uint8_t*)stack0)[47]));
    }
...
L_10040: {//lbu_do_alive
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(uint8_t*)(&(((uint8_t*)stack0)[46]));
    }
