...
L_1014c: {//lw_main
    uint64_t rs1 = c->gp_regs[8];
    int32_t rd = *(int32_t *)(rs1 + (int64_t)-200LL);
    c->gp_regs[15] = rd;
    }
L_10150: {//sw_main
    uint64_t rs1 = c->gp_regs[8];
...
L_10154: {//lw_main
    uint64_t rs1 = c->gp_regs[8];
    int32_t rd = *(int32_t *)(rs1 + (int64_t)-196LL);
    c->gp_regs[15] = rd;
    }
L_10158: {//sw_main
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *(uint32_t *)(rs1 + (int64_t)-200LL) = (uint32_t)rs2;
    }
L_1015c: {//lw_main
    uint64_t rs1 = c->gp_regs[8];
...
L_10160: {//sw_main
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *(uint32_t *)(rs1 + (int64_t)-196LL) = (uint32_t)rs2;
    }
L_10164: {//addi_main
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = rs1 + (int64_t)-200LL;
...
L_1022c: {//ld_main
    uint64_t rs1 = c->gp_regs[2];
    int64_t rd = *(int64_t *)(rs1 + (int64_t)200LL);
    c->gp_regs[1] = rd;
    }
L_10230: {//ld_main
    uint64_t rs1 = c->gp_regs[2];
    int64_t rd = *(int64_t *)(rs1 + (int64_t)192LL);
    c->gp_regs[8] = rd;
    }
L_10234: {//addi_main
    uint64_t rs1 = c->gp_regs[2];
