...
L_10024: {//lwu_my_strlen
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(uint32_t*)(&(((uint8_t*)stack3)[28]));
    }
L_10028: {//ld_my_strlen
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[14] = *(int64_t*)(&(((uint8_t*)stack3)[8]));
    }
...
L_10068: {//lwu_my_strcmp
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(uint32_t*)(&(((uint8_t*)stack2)[28]));
    }
...
L_1007c: {//ld_my_strcmp
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[14] = *(int64_t*)(&(((uint8_t*)stack2)[0]));
    }
...
L_101ac: {//lwu_reverse_string
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(uint32_t*)(&(((uint8_t*)stack1)[44]));
    }
L_101b0: {//ld_reverse_string
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[13] = *(int64_t*)(&(((uint8_t*)stack1)[16]));
    }
...
L_101e4: {//lwu_reverse_string
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(uint32_t*)(&(((uint8_t*)stack1)[12]));
    }
L_101e8: {//ld_reverse_string
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[14] = *(int64_t*)(&(((uint8_t*)stack1)[16]));
    }
...
int is_palindrome(void* arg0){
    ...
    cpu_t *c=&cpu;
    uint64_t stack0[18];
    c->gp_regs[sp]=(uint64_t)&stack0[18];
    c->gp_regs[a0]=arg0;
L_10204: {//addi_is_palindrome
    c->gp_regs[2] = &stack0[18];
    uint64_t rs1 = c->gp_regs[2];
...
L_102dc: {//ld_is_palindrome
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[11] = *(int64_t*)(&(((uint8_t*)stack0)[24]));
    }
...
L_10310: {//ld_is_palindrome
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[1] = *(int64_t*)(&(((uint8_t*)stack0)[136]));
    }
L_10314: {//ld_is_palindrome
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[8] = *(int64_t*)(&(((uint8_t*)stack0)[128]));
    }
L_10318: {//ld_is_palindrome
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[9] = *(int64_t*)(&(((uint8_t*)stack0)[120]));
    }
L_1031c: {//ld_is_palindrome
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[18] = *(int64_t*)(&(((uint8_t*)stack0)[112]));
    }
L_10320: {//ld_is_palindrome
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[19] = *(int64_t*)(&(((uint8_t*)stack0)[104]));
    }
L_10324: {//ld_is_palindrome
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[20] = *(int64_t*)(&(((uint8_t*)stack0)[96]));
    }
L_10328: {//ld_is_palindrome
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[21] = *(int64_t*)(&(((uint8_t*)stack0)[88]));
    }
L_1032c: {//ld_is_palindrome
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[22] = *(int64_t*)(&(((uint8_t*)stack0)[80]));
    }
L_10330: {//ld_is_palindrome
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[23] = *(int64_t*)(&(((uint8_t*)stack0)[72]));
    }
L_10334: {//ld_is_palindrome
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[24] = *(int64_t*)(&(((uint8_t*)stack0)[64]));
    }
L_10338: {//ld_is_palindrome
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[25] = *(int64_t*)(&(((uint8_t*)stack0)[56]));
    }
