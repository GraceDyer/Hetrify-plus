...
L_1004c: {//addi_multiply
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[8] = rs1 + (int64_t)48LL;
    }
L_10050: {//addi_multiply
    uint64_t rs1 = c->gp_regs[10];
    c->gp_regs[15] = rs1 + (int64_t)0LL;
    }
L_10054: {//addi_multiply
...
L_10068: {//addi_multiply
    uint64_t rs1 = c->gp_regs[15];
    c->gp_regs[10] = rs1 + (int64_t)0LL;
    }
L_1006c: {//jal_multiply
    c->gp_regs[1] = 65648LL;
    c->gp_regs[a0] = (uint64_t)custom_abs(c->gp_regs[a0]);
    }
L_10070: {//addi_multiply
    uint64_t rs1 = c->gp_regs[10];
    c->gp_regs[15] = rs1 + (int64_t)0LL;
    }
L_10074: {//addi_multiply
    uint64_t rs1 = c->gp_regs[15];
    c->gp_regs[14] = rs1 + (int64_t)0LL;
    }
L_10078: {//addi_multiply
    uint64_t rs1 = 0;
    c->gp_regs[15] = rs1 + (int64_t)10LL;
    }
L_1007c: {//remw_multiply
    uint64_t rs1 = c->gp_regs[14];
    uint64_t rs2 = c->gp_regs[15];
    c->gp_regs[15] = (rs2 == 0 ? (int64_t)(int32_t)rs1 : (int64_t)(int32_t)((int64_t)(int32_t)rs1 % (int64_t)(int32_t)rs2));
    }
L_10080: {//addiw_multiply
    uint64_t rs1 = c->gp_regs[15];
    c->gp_regs[9] = (int64_t)(int32_t)(rs1 + (int64_t)0LL);
    }
L_10084: {//lw_multiply
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[8]));
    }
L_10088: {//addi_multiply
    uint64_t rs1 = c->gp_regs[15];
    c->gp_regs[10] = rs1 + (int64_t)0LL;
    }
L_1008c: {//jal_multiply
    c->gp_regs[1] = 65680LL;
    c->gp_regs[a0] = (uint64_t)custom_abs(c->gp_regs[a0]);
    }
L_10090: {//addi_multiply
    uint64_t rs1 = c->gp_regs[10];
    c->gp_regs[15] = rs1 + (int64_t)0LL;
    }
L_10094: {//addi_multiply
    uint64_t rs1 = c->gp_regs[15];
    c->gp_regs[14] = rs1 + (int64_t)0LL;
    }
L_10098: {//addi_multiply
    uint64_t rs1 = 0;
    c->gp_regs[15] = rs1 + (int64_t)10LL;
    }
L_1009c: {//remw_multiply
    uint64_t rs1 = c->gp_regs[14];
    uint64_t rs2 = c->gp_regs[15];
    c->gp_regs[15] = (rs2 == 0 ? (int64_t)(int32_t)rs1 : (int64_t)(int32_t)((int64_t)(int32_t)rs1 % (int64_t)(int32_t)rs2));
    }
L_100a0: {//addiw_multiply
    uint64_t rs1 = c->gp_regs[15];
    c->gp_regs[15] = (int64_t)(int32_t)(rs1 + (int64_t)0LL);
    }
L_100a4: {//mulw_multiply
    uint64_t rs1 = c->gp_regs[9];
    uint64_t rs2 = c->gp_regs[15];
    c->gp_regs[15] = (int64_t)(int32_t)(rs1 * rs2);
    }
L_100a8: {//addiw_multiply
    uint64_t rs1 = c->gp_regs[15];
    c->gp_regs[15] = (int64_t)(int32_t)(rs1 + (int64_t)0LL);
    }
L_100ac: {//addi_multiply
    uint64_t rs1 = c->gp_regs[15];
    c->gp_regs[10] = rs1 + (int64_t)0LL;
    }
L_100b0: {//ld_multiply
...
L_100b8: {//ld_multiply
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[9] = *(int64_t*)(&(((uint8_t*)stack0)[24]));
    }
L_100bc: {//addi_multiply
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[2] = rs1 + (int64_t)48LL;
    }
L_100c0: {//jalr_multiply
    uint64_t rs1 = c->gp_regs[1];
    return (int)c->gp_regs[a0];
    }
}
