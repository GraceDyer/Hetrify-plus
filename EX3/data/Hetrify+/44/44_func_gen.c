...
char* change_base(int arg0, int arg1){
    ...
    cpu_t *c=&cpu;
    uint64_t stack0[44];
    c->gp_regs[sp]=(uint64_t)&stack0[44];
    c->gp_regs[a0]=arg0;
    c->gp_regs[a1]=arg1;
L_10000: {//addi_change_base
    c->gp_regs[2] = &stack0[44];
...
L_10004: {//sd_change_base
    ...
    *( uint64_t*)(&(((uint8_t*)stack0)[344]))=(uint64_t)rs2;
    }
...
L_10020: {//sw_change_base
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = 0;
    *( uint32_t*)(&(((uint8_t*)stack0)[332]))=(uint32_t)rs2;
    }
L_10024: {//sw_change_base
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = 0;
    *( uint32_t*)(&(((uint8_t*)stack0)[328]))=(uint32_t)rs2;
    }
...
L_1004c: {//lw_change_base
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[332]));
    }
...
L_100a4: {//sw_change_base
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint32_t*)(&(((uint8_t*)stack0)[324]))=(uint32_t)rs2;
    }
...
L_100ac: {//lw_change_base
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[324]));
    }
...
L_100c0: {//sw_change_base
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint32_t*)(&(((uint8_t*)stack0)[320]))=(uint32_t)rs2;
    }
L_100c4: {//sw_change_base
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = 0;
    *( uint32_t*)(&(((uint8_t*)stack0)[316]))=(uint32_t)rs2;
    }
L_100c8: {//sw_change_base
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = 0;
    *( uint32_t*)(&(((uint8_t*)stack0)[312]))=(uint32_t)rs2;
    }
L_100cc: {//lw_change_base
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[320]));
    }
...
L_100d8: {//lw_change_base
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[316]));
    }
...
L_10110: {//lw_change_base
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[312]));
    }
...
L_1016c: {//lw_change_base
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[14] = *(int32_t*)(&(((uint8_t*)stack0)[312]));
    }
...
L_101a4: {//sw_change_base
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = 0;
    *( uint32_t*)(&(((uint8_t*)stack0)[308]))=(uint32_t)rs2;
    }
...
L_101ac: {//lw_change_base
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[14] = *(int32_t*)(&(((uint8_t*)stack0)[308]));
    }
...
L_101b8: {//lw_change_base
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[328]));
    }
...
L_101e0: {//lw_change_base
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[308]));
    }
...
L_1022c: {//ld_change_base
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[8] = *(int64_t*)(&(((uint8_t*)stack0)[344]));
    }
