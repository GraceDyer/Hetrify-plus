...
L_10064: {//sb_simplified_atoi
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = 0;
    *( uint8_t*)(&(((uint8_t*)stack1)[23]))=(uint8_t)rs2;
    }
...
L_100f4: {//lbu_simplified_atoi
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(uint8_t*)(&(((uint8_t*)stack1)[23]));
    }
...
_Bool simplify(void* arg0, void* arg1){
    ...
    cpu_t *c=&cpu;
    uint64_t stack0[14];
    c->gp_regs[sp]=(uint64_t)&stack0[14];
    c->gp_regs[a0]=arg0;
    c->gp_regs[a1]=arg1;
L_10124: {//addi_simplify
    c->gp_regs[2] = &stack0[14];
    uint64_t rs1 = c->gp_regs[2];
...
L_10148: {//sw_simplify
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = 0;
    *( uint32_t*)(&(((uint8_t*)stack0)[80]))=(uint32_t)rs2;
    }
L_1014c: {//sw_simplify
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = 0;
...
L_103e4: {//lw_simplify
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[84]));
    }
...
L_103f8: {//lw_simplify
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[80]));
    }
...
L_10420: {//ld_simplify
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[1] = *(int64_t*)(&(((uint8_t*)stack0)[104]));
    }
L_10424: {//ld_simplify
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[8] = *(int64_t*)(&(((uint8_t*)stack0)[96]));
    }
