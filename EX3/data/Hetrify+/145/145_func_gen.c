...
L_1001c: {//lw_abs_c
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[14] = *(int32_t*)(&(((uint8_t*)stack2)[12]));
    }
L_10020: {//xor_abs_c
    uint64_t rs1 = c->gp_regs[15];
...
L_1004c: {//sd_int_to_str
    ...
    *( uint64_t*)(&(((uint8_t*)stack1)[0]))=(uint64_t)rs2;
    }
...
L_10068: {//ld_int_to_str
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int64_t*)(&(((uint8_t*)stack1)[0]));
    }
...
L_100ec: {//lw_int_to_str
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack1)[32]));
    }
...
L_10124: {//lw_int_to_str
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack1)[40]));
    }
...
L_10140: {//lw_int_to_str
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[13] = *(int32_t*)(&(((uint8_t*)stack1)[44]));
    }
...
void order_by_points(void* arg0, int arg1, int* arg2){
    ...
    cpu_t *c=&cpu;
    uint64_t stack0[142];
    c->gp_regs[sp]=(uint64_t)&stack0[142];
    c->gp_regs[a0]=arg0;
    c->gp_regs[a1]=arg1;
    c->gp_regs[a2]=arg2;
L_101e4: {//addi_order_by_points
    c->gp_regs[2] = &stack0[142];
    uint64_t rs1 = c->gp_regs[2];
...
L_101e8: {//sd_order_by_points
    ...
    *( uint64_t*)(&(((uint8_t*)stack0)[1128]))=(uint64_t)rs2;
    }
L_101ec: {//sd_order_by_points
    uint64_t rs1 = c->gp_regs[2];
    uint64_t rs2 = c->gp_regs[8];
    *( uint64_t*)(&(((uint8_t*)stack0)[1120]))=(uint64_t)rs2;
    }
...
L_10204: {//sd_order_by_points
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = 0;
    *( uint64_t*)(&(((uint8_t*)stack0)[1096]))=(uint64_t)rs2;
    }
...
L_10210: {//sw_order_by_points
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = 0;
    *( uint32_t*)(&(((uint8_t*)stack0)[1116]))=(uint32_t)rs2;
    }
...
L_10218: {//lw_order_by_points
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[1116]));
    }
...
L_1022c: {//sw_order_by_points
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint32_t*)(&(((uint8_t*)stack0)[1088]))=(uint32_t)rs2;
    }
L_10230: {//lw_order_by_points
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[1088]));
    }
...
L_10240: {//sw_order_by_points
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint32_t*)(&(((uint8_t*)stack0)[1084]))=(uint32_t)rs2;
    }
...
L_10248: {//lw_order_by_points
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[1084]));
    }
...
L_1025c: {//sw_order_by_points
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint32_t*)(&(((uint8_t*)stack0)[1080]))=(uint32_t)rs2;
    }
L_10260: {//sw_order_by_points
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = 0;
    *( uint32_t*)(&(((uint8_t*)stack0)[1108]))=(uint32_t)rs2;
    }
...
L_10268: {//sw_order_by_points
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint32_t*)(&(((uint8_t*)stack0)[1112]))=(uint32_t)rs2;
    }
...
L_10270: {//lw_order_by_points
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[1112]));
    }
...
L_1028c: {//lw_order_by_points
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[14] = *(int32_t*)(&(((uint8_t*)stack0)[1108]));
    }
...
L_102ac: {//lw_order_by_points
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[1080]));
    }
...
L_102d4: {//lbu_order_by_points
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(uint8_t*)(&(((uint8_t*)stack0)[1064]));
    }
...
L_10318: {//ld_order_by_points
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[14] = *(int64_t*)(&(((uint8_t*)stack0)[1096]));
    }
...
L_103d0: {//sw_order_by_points
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint32_t*)(&(((uint8_t*)stack0)[1092]))=(uint32_t)rs2;
    }
...
L_103f0: {//ld_order_by_points
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[13] = *(int64_t*)(&(((uint8_t*)stack0)[1096]));
    }
...
L_10414: {//lw_order_by_points
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[14] = *(int32_t*)(&(((uint8_t*)stack0)[1092]));
    }
...
L_104cc: {//ld_order_by_points
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[1] = *(int64_t*)(&(((uint8_t*)stack0)[1128]));
    }
L_104d0: {//ld_order_by_points
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[8] = *(int64_t*)(&(((uint8_t*)stack0)[1120]));
    }
