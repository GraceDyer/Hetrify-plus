...
L_10064: {//ld_my_strstr
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[10] = *(int64_t*)(&(((uint8_t*)stack1)[8]));
    }
...
L_10074: {//ld_my_strstr
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[10] = *(int64_t*)(&(((uint8_t*)stack1)[0]));
    }
...
L_10080: {//sw_my_strstr
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint32_t*)(&(((uint8_t*)stack1)[16]))=(uint32_t)rs2;
    }
L_10084: {//lw_my_strstr
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack1)[16]));
    }
...
L_100d0: {//ld_my_strstr
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[14] = *(int64_t*)(&(((uint8_t*)stack1)[0]));
    }
...
int cycpattern_check(void* arg0, void* arg1){
    ...
    cpu_t *c=&cpu;
    uint64_t stack0[132];
    c->gp_regs[sp]=(uint64_t)&stack0[132];
    c->gp_regs[a0]=arg0;
    c->gp_regs[a1]=arg1;
L_1017c: {//addi_cycpattern_check
    c->gp_regs[2] = &stack0[132];
    uint64_t rs1 = c->gp_regs[2];
...
L_10180: {//sd_cycpattern_check
    uint64_t rs1 = c->gp_regs[2];
    uint64_t rs2 = c->gp_regs[1];
    *( uint64_t*)(&(((uint8_t*)stack0)[1048]))=(uint64_t)rs2;
    }
L_10184: {//sd_cycpattern_check
    uint64_t rs1 = c->gp_regs[2];
    uint64_t rs2 = c->gp_regs[8];
    *( uint64_t*)(&(((uint8_t*)stack0)[1040]))=(uint64_t)rs2;
    }
...
L_101a0: {//sw_cycpattern_check
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint32_t*)(&(((uint8_t*)stack0)[1020]))=(uint32_t)rs2;
    }
L_101a4: {//lw_cycpattern_check
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[1020]));
    }
...
L_101b8: {//sw_cycpattern_check
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = 0;
    *( uint32_t*)(&(((uint8_t*)stack0)[1036]))=(uint32_t)rs2;
    }
...
L_101c0: {//sw_cycpattern_check
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = 0;
    *( uint32_t*)(&(((uint8_t*)stack0)[1032]))=(uint32_t)rs2;
    }
L_101c4: {//lw_cycpattern_check
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[1036]));
    }
L_101c8: {//sw_cycpattern_check
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint32_t*)(&(((uint8_t*)stack0)[1028]))=(uint32_t)rs2;
    }
...
L_101d0: {//lw_cycpattern_check
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[1028]));
    }
...
L_101dc: {//lw_cycpattern_check
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[1032]));
    }
...
L_1021c: {//sw_cycpattern_check
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = 0;
    *( uint32_t*)(&(((uint8_t*)stack0)[1024]))=(uint32_t)rs2;
    }
...
L_10224: {//lw_cycpattern_check
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[1024]));
    }
...
L_102cc: {//ld_cycpattern_check
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[1] = *(int64_t*)(&(((uint8_t*)stack0)[1048]));
    }
L_102d0: {//ld_cycpattern_check
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[8] = *(int64_t*)(&(((uint8_t*)stack0)[1040]));
    }
