...
int get_matrix_triples(int arg0){
    ...
    cpu_t *c=&cpu;
    uint64_t stack0[66];
    c->gp_regs[sp]=(uint64_t)&stack0[66];
    c->gp_regs[a0]=arg0;
L_10000: {//addi_get_matrix_triples
    c->gp_regs[2] = &stack0[66];
...
L_10004: {//sd_get_matrix_triples
    ...
    *( uint64_t*)(&(((uint8_t*)stack0)[520]))=(uint64_t)rs2;
    }
...
L_10038: {//sw_get_matrix_triples
    ...
    *( uint32_t*)(&(((uint8_t*)stack0)[480]))=(uint32_t)rs2;
    }
L_1003c: {//sd_get_matrix_triples
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = 0;
    *( uint64_t*)(&(((uint8_t*)stack0)[488]))=(uint64_t)rs2;
    }
...
L_1006c: {//sw_get_matrix_triples
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = 0;
    *( uint32_t*)(&(((uint8_t*)stack0)[508]))=(uint32_t)rs2;
    }
...
L_10074: {//lw_get_matrix_triples
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[508]));
    }
...
L_100b8: {//ld_get_matrix_triples
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[14] = *(int64_t*)(&(((uint8_t*)stack0)[488]));
    }
...
L_100e8: {//lw_get_matrix_triples
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[14] = *(int32_t*)(&(((uint8_t*)stack0)[508]));
    }
...
L_100fc: {//sw_get_matrix_triples
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = 0;
    *( uint32_t*)(&(((uint8_t*)stack0)[504]))=(uint32_t)rs2;
    }
...
L_10110: {//lw_get_matrix_triples
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[504]));
    }
...
L_10140: {//sw_get_matrix_triples
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint32_t*)(&(((uint8_t*)stack0)[484]))=(uint32_t)rs2;
    }
...
L_10170: {//lw_get_matrix_triples
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[12] = *(int32_t*)(&(((uint8_t*)stack0)[504]));
    }
...
L_1019c: {//lw_get_matrix_triples
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[11] = *(int32_t*)(&(((uint8_t*)stack0)[504]));
    }
...
L_1022c: {//ld_get_matrix_triples
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[13] = *(int64_t*)(&(((uint8_t*)stack0)[488]));
    }
...
L_1026c: {//lw_get_matrix_triples
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[484]));
    }
...
L_102a8: {//sw_get_matrix_triples
    uint64_t rs1 = c->gp_regs[8];
    uint64_t rs2 = c->gp_regs[15];
    *( uint32_t*)(&(((uint8_t*)stack0)[500]))=(uint32_t)rs2;
    }
...
L_103a8: {//lw_get_matrix_triples
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[14] = *(int32_t*)(&(((uint8_t*)stack0)[504]));
    }
...
L_103d0: {//lw_get_matrix_triples
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[13] = *(int32_t*)(&(((uint8_t*)stack0)[508]));
    }
...
L_10408: {//lw_get_matrix_triples
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[10] = *(int32_t*)(&(((uint8_t*)stack0)[504]));
    }
...
L_1059c: {//lw_get_matrix_triples
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[500]));
    }
...
L_105f8: {//ld_get_matrix_triples
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[8] = *(int64_t*)(&(((uint8_t*)stack0)[520]));
    }
