...
int fib(int arg0){
    ...
    cpu_t *c=&cpu;
    uint64_t stack0[254];
    c->gp_regs[sp]=(uint64_t)&stack0[254];
    c->gp_regs[a0]=arg0;
L_10000: {//addi_fib
    c->gp_regs[2] = &stack0[254];
...
L_10004: {//sd_fib
    ...
    *( uint64_t*)(&(((uint8_t*)stack0)[2024]))=(uint64_t)rs2;
    }
L_10008: {//addi_fib
    uint64_t rs1 = c->gp_regs[2];
...
L_1004c: {//sw_fib
    ...
    *( uint32_t*)(&(((uint8_t*)stack0)[2012]))=(uint32_t)rs2;
    }
L_10050: {//jal_fib
    goto L_100cc;
    }
L_10054: {//lw_fib
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[15] = *(int32_t*)(&(((uint8_t*)stack0)[2012]));
    }
L_10058: {//addiw_fib
    uint64_t rs1 = c->gp_regs[15];
...
L_100d8: {//lw_fib
    uint64_t rs1 = c->gp_regs[8];
    c->gp_regs[14] = *(int32_t*)(&(((uint8_t*)stack0)[2012]));
    }
L_100dc: {//lw_fib
    uint64_t rs1 = c->gp_regs[15];
...
L_1011c: {//ld_fib
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[8] = *(int64_t*)(&(((uint8_t*)stack0)[2024]));
    }
L_10120: {//addi_fib
    uint64_t rs1 = c->gp_regs[2];
    c->gp_regs[2] = rs1 + (int64_t)2032LL;
