...
L_10040: {//sb_decimal_to_binary
    uint64_t rs1 = c->gp_regs[15];
    uint64_t rs2 = c->gp_regs[14];
    *(uint8_t *)((uint64_t)(&str[0])+66025LL-66024LL) = (uint8_t)rs2;
    }
...
L_10050: {//sb_decimal_to_binary
    uint64_t rs1 = c->gp_regs[15];
    uint64_t rs2 = c->gp_regs[14];
    *(uint8_t *)((uint64_t)(&str[0])+66026LL-66024LL) = (uint8_t)rs2;
    }
...
L_10060: {//sb_decimal_to_binary
    uint64_t rs1 = c->gp_regs[15];
    uint64_t rs2 = c->gp_regs[14];
    *(uint8_t *)((uint64_t)(&str[0])+66027LL-66024LL) = (uint8_t)rs2;
    }
...
L_10070: {//sb_decimal_to_binary
    uint64_t rs1 = c->gp_regs[15];
    uint64_t rs2 = c->gp_regs[14];
    *(uint8_t *)((uint64_t)(&str[0])+66028LL-66024LL) = (uint8_t)rs2;
    }
...
L_1007c: {//sb_decimal_to_binary
    uint64_t rs1 = c->gp_regs[15];
    uint64_t rs2 = 0;
    *(uint8_t *)((uint64_t)(&str[0])+66029LL-66024LL) = (uint8_t)rs2;
    }
